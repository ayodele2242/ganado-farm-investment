          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h4 class="mt-0 mb-0 text-white" ><i class="material-icons">people</i> Failed Transactions</h4>
              </div>
        ...
        <tr class="animated fadeIn">
          ...
          <td>
            ...
            <button id="<?php echo $rows['id']; ?>" class="btn btn-floating delUser waves-effect waves-light red z-depth-4 btn-small" type="button" title="Delete"><i class="material-icons left">delete</i></button>
             <a href="#user-modal" data-id="<?php echo $rows['id']; ?>" id="<?php echo $rows['id']; ?>" class="btn btn-floating waves-effect waves-light orange z-depth-3 btn-small modal-trigger usermodal" type="button" title="Edit"><i class="material-icons left">create</i></a>
